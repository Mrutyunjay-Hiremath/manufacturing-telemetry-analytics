...
This repository contains my solution for the Deloitte Technology Consulting Job Simulation on Forage. The goal of this project was to analyze manufacturing telemetry data for a client (Daikibo) to identify where and why their assembly lines were experiencing disruptions.
